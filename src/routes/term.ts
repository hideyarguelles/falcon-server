...
export default new Router()
    ...
    .get("/", termView.getAll)
    .post("/", termView.add)
    .get("/current-stats", termView.getFacultyMemberStats)
    .get("/underloaded-last-term", termView.getUnderloadedFacultiesLastTerm)
    .get("/year/:year", termView.getTermsFromYear)
    ...
    .post("/:termId/class-schedules/:classScheduleId/set-adjunct", termView.setAdjunct)
